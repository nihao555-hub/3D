...
import { Route as ApiMeshCheckRouteImport } from './routes/api/mesh-check'
...
const ApiMeshCheckRoute = ApiMeshCheckRouteImport.update({
  id: '/api/mesh-check',
  path: '/api/mesh-check',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/mesh-check': typeof ApiMeshCheckRoute
...
export interface RootRouteChildren {
  ...
  ApiMeshCheckRoute: typeof ApiMeshCheckRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/mesh-check': {
      id: '/api/mesh-check'
      path: '/api/mesh-check'
      fullPath: '/api/mesh-check'
      preLoaderRoute: typeof ApiMeshCheckRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/mesh': {
      id: '/api/mesh'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiMeshCheckRoute: ApiMeshCheckRoute,
